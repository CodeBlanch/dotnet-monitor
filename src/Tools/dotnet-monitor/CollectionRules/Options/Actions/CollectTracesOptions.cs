...
{
    /// <summary>
    /// Options for the CollectTracesOptions action.
    /// </summary>
    [DebuggerDisplay("CollectTracesOptions")]
#if SCHEMAGEN
    [NJsonSchema.Annotations.JsonSchemaFlatten]
#endif
    internal sealed partial record class CollectTracesOptions : BaseRecordOptions, IEgressProviderProperties
    {
        [Display(
            ResourceType = typeof(OptionsDisplayStrings),
            Description = nameof(OptionsDisplayStrings.DisplayAttributeDescription_CollectTracesOptions_Sources))]
